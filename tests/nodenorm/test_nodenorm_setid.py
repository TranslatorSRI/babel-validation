...
def test_setid_incorrect_conflation(nodenorm_url):
    ...
    response = requests.get(
        nodenorm_url + "get_setid",
        params={"curie": ["DOID:3812", "MONDO:0005002", "MONDO:0005003"], "conflation": ["GeneProtein", "DrugChemic"]},
    )
    result = response.json()
...
def test_setid_long(nodenorm_url):
    ...
    response = requests.get(nodenorm_url + "get_setid", params={"curie": rubbish_ids})
    result = response.json()
