...
def pytest_generate_tests(metafunc):
    ...
    if deselected_by_markexpr(metafunc):
        # Parametrizing fetches issues from GitHub at collection time. Skip the
        # network round trip when a -m filter (e.g. `pytest -m unit`) would
        # deselect this test anyway.
